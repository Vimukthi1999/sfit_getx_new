            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage(AppImgPath.logo), fit: BoxFit.fill),
              ),
            ),
            SizedBox(width: 20.w),
            Container(
...
Widget buildPreviewHeader(
    BuildContext context, String subTitle, var perviewOpen) {
  return Container(
    //width: 600,
          ...
          children: <Widget>[
            ...
            Container(
              child: Column(
                ...
                children: <Widget>[
                  Container(
                      alignment: Alignment.topLeft, child: appheaderTitle()),
                  //SizedBox(height: 10,),
